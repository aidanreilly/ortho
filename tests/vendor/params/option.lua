...
-- lua/core/params/option.lua. References the globals `util` and `norns`
-- (test files must set both before requiring this, directly or
-- transitively via tests/vendor/paramset.lua).
local tab = require 'tests.vendor.tabutil'
